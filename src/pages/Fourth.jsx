...
function Fourth() {
    return (
        ...
        <div id="Achieve" className="m-8">
            <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 px-4 mt-4 lg:mt-[180px]">
                <div className="lg:text-left m-4 lg:m-8">
                    <ScrollFloat
                        animationDuration={1}
                        ease='back.inOut(2)'
